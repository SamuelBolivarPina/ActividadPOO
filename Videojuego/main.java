...
public class main {
    ...
    /*
      CÓDIGO INCORRECTO (La clase existe, pero 'main' está vacío o no la usa):

      public static void main(String[] args) {
          // El método main no contiene código o ignora la entidad 'Videojuego'.
    ...
    public static void main(String[] args) {
        // --- CÓDIGO CORREGIDO: Declarar e invocar la entidad en el main ---
        ...
        /*
          ...
          1. En POO: Definir una clase solo crea el plano o la plantilla en el archivo .java.
             Si en el método 'main' no se construye la instancia (objeto) ni se llaman a sus métodos,
          ...
          2. En enfoque procedimental: Del mismo modo, declarar funciones o variables en una clase
             no sirve de nada si el punto de entrada 'main' no las invoca explícitamente para
